...
[Saprox,Sexact,gridTime] = GeneratePathsGBMEuler(NoOfPaths,NoOfSteps,T,r,sigma,S0);
...
for NoOfSteps = NoOfStepsV
    [Saprox,Sexact,~] = GeneratePathsGBMEuler(NoOfPaths,NoOfSteps,T,r,sigma,S0);
