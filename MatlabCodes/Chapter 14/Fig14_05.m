...
figure(1)
plot(time,Rates2008,'linewidth',2,'color',[0 0.45 0.74])
grid on;
title('Interest Rates, EUR1M, 2008')
xlabel('time in years')
ylabel('yield')

figure(2)
[a,~]=find(Rates2017<0);
plot(time(1:a(end)),Rates2017(1:a(end)),'linewidth',2,'color',[1,0,0])
hold on
plot(time(a(end):end),Rates2017(a(end):end),'linewidth',2,'color',[0 0.45 0.74])
plot([time(a(end)),time(a(end))],[-0.8,0],'--r')
plot([0,time(a(end))],[0,0],'--r')
grid on

title('Interest Rates, EUR1M, 2017')
xlabel('time in years')
ylabel('yield')